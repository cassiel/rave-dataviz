...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.0, 259.396698, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 345.274353, 79.0, 54.0, 20.0 ],
					"text" : "route int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 212.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 772.0, 212.0, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 772.0, 180.0, 72.0, 20.0 ],
					"text" : "split 0. 0.49"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 304.774353, 757.0, 46.0, 20.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.774353, 781.0, 109.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.774353, 803.0, 109.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.774353, 713.0, 68.0, 20.0 ],
					"text" : "r ---bypass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.774353, 748.0, 54.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 961.5, 235.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 908.5, 235.0, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 908.5, 203.0, 72.0, 20.0 ],
					"text" : "split 0. 0.49"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 908.5, 115.0, 81.0, 20.0 ],
					"text" : "playr-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "toggle low/high brightness playback rate range (0. - .49 = low, .5 - 1.0 = high, off/on). The message \"read <optional movie filename>\" can be used to load a movie.",
					"id" : "obj-33",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 908.5, 36.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"clickedimage" : 1,
					"hint" : "Data received in this inlet starts or stops playback (off/on messages or float values (0. - .49 = off, .5 - 1.0 = on).",
					"id" : "obj-5",
					"maxclass" : "pictctrl",
					"mode" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 772.0, 115.0, 78.0, 20.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "toggle playback (0. - .49 = off, .5 - 1.0 = on, off/on)",
					"id" : "obj-9",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 730.0, 882.0, 13.0, 13.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"clickedimage" : 1,
					"hint" : "Data received in this inlet sets the ending point for looping the movie (0. - 1.0, off/on).",
					"id" : "obj-48",
					"maxclass" : "pictctrl",
					"mode" : 1,
					"name" : "pvr-data-button.png",
					...
					"presentation" : 1,
					"presentation_rect" : [ 83.0, 4.0, 13.0, 13.0 ],
					"snap" : 1
				}
...
, 			{
				"box" : 				{
					"clickedimage" : 1,
					"hint" : "Data received in this inlet sets the starting point for looping the movie (0. - 1.0, off/on).",
					"id" : "obj-41",
					"maxclass" : "pictctrl",
					"mode" : 1,
					"name" : "pvr-data-button.png",
					...
					"presentation" : 1,
					"presentation_rect" : [ 44.0, 4.0, 13.0, 13.0 ],
					"snap" : 1
				}
...
, 			{
				"box" : 				{
					"clickedimage" : 1,
					"hint" : "Data received in this inlet sets the playback rate slider (0. - 1.0, off/on). 0/1 (integer) turns module off/on",
					"id" : "obj-40",
					"maxclass" : "pictctrl",
					"mode" : 1,
					"name" : "pvr-data-button.png",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1201.0, 281.939758, 136.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1201.0, 334.399963, 142.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1201.0, 319.399963, 142.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 380.0, 233.671921, 98.099991, 23.400011 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"comment" : "Set playback rate (0. - 1.0, off/on), 0/1 (int) toggles playback",
					"id" : "obj-76",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.274353, 36.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1201.0, 300.5, 136.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1041.0, 50.0, 46.0, 20.0 ],
					"text" : "t 0 1 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 765.0, 741.0, 43.0, 20.0 ],
					"text" : "pipe 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 29.0, 110.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 730.0, 903.0, 54.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1042.0, 22.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					"comment" : "loop start (0. - 1.0, off/on)",
					"id" : "obj-68",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "movie playback position data (0. - 1.0, off/on)",
					"id" : "obj-17",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 731.0, 927.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1201.0, 355.5, 80.0, 20.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 726.0, 375.0, 427.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 183.0, 474.0, 101.0, 20.0 ],
									"text" : "/ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 8,
									"outlettype" : [ "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 183.0, 245.0, 653.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "jit.qt.movie 640 480 @vol 0. @autostart 0 @unique 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1201.0, 181.5, 151.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 107.0, 126.0, 38.0, 47.0 ],
					"text" : "–",
					"textcolor" : [ 0.25098, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1198.177734, 409.451294, 32.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1198.177734, 387.967102, 32.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"clickedimage" : 1,
					"hint" : "Data received in this inlet toggles low/high playback rate (0. - .49 = low, .5 - 1.0 = high, off/on). You can also send the message \"read <optional movie name>\" to load a movie.",
					"id" : "obj-66",
					"maxclass" : "pictctrl",
					"mode" : 1,
					"name" : "pvr-data-button.png",
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1019.5, 115.0, 13.0, 13.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 8.834721, 70.628098, 100.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.774353, 833.0, 81.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 96.0, 68.0, 26.0 ],
					"text" : "Display",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.774353, 866.0, 81.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 111.0, 83.0, 26.0 ],
					"text" : "bypassed",
					"textcolor" : [ 1.0, 1.0, 1.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 134.774353, 775.0, 160.0, 120.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 55.0, 112.0, 84.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1201.0, 229.5, 100.0, 50.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 971.0, 269.431793, 314.886475, 269.431793 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 949.0, 407.5, 64.5, 407.5 ],
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 834.5, 239.0, 758.5, 239.0, 758.5, 159.0, 64.5, 159.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 781.5, 239.0, 757.0, 239.0, 757.0, 159.0, 64.5, 159.0 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 882.0, 137.0, 868.0, 137.0, 868.0, 105.0, 840.5, 105.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1064.0, 787.5, 737.0, 787.5 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1064.0, 92.0, 490.0, 92.0 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1064.0, 92.5, 622.0, 92.5 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1064.0, 92.5, 747.0, 92.5 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1064.0, 92.5, 882.0, 92.5 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1077.5, 441.5, 533.886475, 441.5 ],
					"source" : [ "obj-50", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1077.5, 164.5, 414.0, 164.5 ],
					"source" : [ "obj-50", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1064.0, 92.0, 1026.5, 92.0 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1050.5, 589.0, 99.0, 589.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1050.5, 340.931793, 314.886475, 340.931793 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 840.5, 144.0, 861.25, 144.0, 861.25, 106.0, 882.0, 106.0 ],
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 918.0, 269.431793, 314.886475, 269.431793 ],
					"source" : [ "obj-74", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 127.5, 667.5, 774.5, 667.5 ],
					"source" : [ "obj-8", 0 ]
				}
